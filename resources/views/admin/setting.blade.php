    ...
    <div class="row g-4">
        <div class="col-auto">
            <div>
                ...
                <img src="{{asset('assets/images/users/avatar-8.jpg')}}" alt="user-img" class="proifile-img rounded-circle" />
                @else
                <img src="{{asset( ''.auth()->user()->getAdminProfileImage())}}" alt="user-img" class="proifile-img rounded-circle" />
                @endif
            </div>
        </div>
        <!--end col-->
